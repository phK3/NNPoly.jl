...
println("aCROWN ...")
solver = aCROWN()
properties, times, y_starts, ys, y_hists = verify_vnnlib(solver, MNIST_PATH, logfile="./eval/mnist_results_aCROWN_long2.jld2", max_properties=5, print_freq=10, n_steps=999999999, save_history=true, timeout=3600, start_idx=6, force_gc=true)
