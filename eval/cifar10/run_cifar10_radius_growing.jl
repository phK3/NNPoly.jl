...
properties, times, y_starts, ys, y_hists = verify_vnnlib(solver, CIFAR_PATH, logfile="./eval/cifar10_results_PolyCROWN_radius_growing.jld2",  max_properties=2, print_freq=1, n_steps=10, save_history=true, timeout=3600, force_gc=true)
...
logfile = logfile_prefix * "logs__radii_" * date_string * ".csv"
    ...
    for prop in properties
        for n_un in n_unfixed
            ...
            for r in radii
                ...
                vnnlib_path = "./eval/cifar10/vnnlib/prop_$(prop)_spiral_$(n_un)_radius_$(r).vnnlib"
                ...
                hist_file_name = logfile_prefix * "$(model_name)_$(prop)_$(n_un)_$(r)_hist_" * date_string * ".jld2"
